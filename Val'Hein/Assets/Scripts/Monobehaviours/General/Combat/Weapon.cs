...
{
	[SerializeField]
	private Stats statsIncreasers;
	public Stats stats => statsIncreasers;
	...
	private void DoDamage(IDamageable dmg) => dmg.TakeDamage(finalDamage * damageMultiplier, DamageType.MeleeAttack);
}
